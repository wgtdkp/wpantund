...
SpinelNCPInstance::regsiter_all_get_handlers(void)
{
	...
	register_get_handler_spinel_unpacker(
		...
		SPINEL_PROP_THREAD_BACKBONE_ROUTER_PRIMARY, boost::bind(unpack_bbr_dataset, _1, _2, _3, /* as_val_map */ true));
//	register_get_handler_spinel_unpacker(
//		kWPANTUNDProperty_ThreadLocalBbr,
//		SPINEL_PROP_THREAD_BACKBONE_ROUTER_LOCAL, boost::bind(unpack_bbr_dataset, _1, _2, _3, /* as_val_map */ false));
	register_get_handler_spinel_unpacker(
